...
class SkillconnectSupabaseUser extends BaseAuthUser {
  SkillconnectSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> skillconnectSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = SkillconnectSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
